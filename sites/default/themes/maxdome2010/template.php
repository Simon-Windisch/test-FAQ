...
if (theme_get_setting('basic_zen_tabs')) {
  drupal_add_css( drupal_get_path('theme', 'maxdome2010') .'/css/tabs.css', 'theme', 'screen');
}

// Add JS for Homepage
if (drupal_is_front_page()) {
  drupal_add_js(drupal_get_path('theme', 'maxdome2010').'sites/default/includes/stage.js', 'theme');
}

// Additional JS for popups etc.
drupal_add_js(drupal_get_path('theme', 'maxdome2010').'sites/default/includes/tools.js', 'theme');
drupal_add_js(drupal_get_path('theme', 'maxdome2010').'sites/default/includes/form-defaults.js', 'theme');
